    ...
    <div class="w-64 h-full bg-[#F5F5F5] text-slate-800 fixed left-0">
      <div class="p-4">
        <ul class="px-2">
          <li>
            <NuxtLink
              to="/dashboard_properties/dashboard"
              class="py-4 px-2 font-bold hover:bg-pink-200 hover:text-pink-700 hover:border rounded-lg flex items-center space-x-2 gap-4"
            >
              <!-- SVG Icon -->
              <svg
                width="24"
          ...
          <li>
            <NuxtLink
              to="/dashboard_properties/period_calendar"
          ...
          <li>
            <NuxtLink
              to="/dashboard_properties/nutrition"
              class="py-4 px-2 font-medium hover:bg-pink-200 hover:text-pink-700 hover:border rounded-lg flex items-center space-x-2 gap-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
          ...
          <li>
            <NuxtLink
              to="/dashboard_properties/appointment"
              class="py-4 px-2 font-medium hover:bg-pink-200 hover:text-pink-700 hover:border rounded-lg flex items-center space-x-2 gap-4"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
